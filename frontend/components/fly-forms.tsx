...
export function ContainerForm({state, source, mode, eggBatch, close, saved}: {state: AppState; source?: Culture; mode?: 'transfer' | 'generation' | 'renew' | 'edit'; eggBatch?: EggBatch; close: () => void; saved: (id?: string) => Promise<void>}) {
